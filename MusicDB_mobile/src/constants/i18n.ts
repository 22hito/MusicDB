...
export const I18N = {
  uk: {
    ...
    'taste.graphPeople': 'Карта смаку',
    'graph.titleSongs': 'Граф пісень',
    'graph.searchPlaceholder': 'Знайти пісню для графа…',
    'graph.egoTitle': 'Схожі на «{song}»',
    'graph.egoHint': 'У центрі — обрана пісня; ближче — схожіші (жанри, виконавець, альбом). Натисніть пісню — граф навколо неї, центральну — відтворити.',
    'taste.meTitle': 'Ваш смак',
    'taste.meStats': '{fav} улюблених · {n} пісень у смаку',
    'taste.filterAll': 'Усі',
    'taste.filterFriends': 'Друзі',
    'taste.filterOthers': 'Інші',
    'taste.filterEmpty': 'Нікого в цьому фільтрі',
    'taste.playShared': 'Слухати спільне',
    'taste.requestSent': 'Запит надіслано',
    'taste.mapHint': 'У центрі — ви; ближче — схожіший смак (кола — 75/50/25% збігу). Зелений обідок — друзі. Натисніть на людину, щоб відкрити профіль.',
    'taste.artistsHint': 'Люди та їхні улюблені виконавці. Золотий обідок — ваші виконавці, зелений — друзі; розмір виконавця — скільки людей його люблять.',
  ...
  en: {
    ...
    'taste.graphPeople': 'Taste map',
    'graph.titleSongs': 'Song graph',
    'graph.searchPlaceholder': 'Find a song for the graph…',
    'graph.egoTitle': 'Similar to “{song}”',
    'graph.egoHint': 'The chosen song is in the center; closer means more similar (genres, artist, album). Tap a song to re-center, the center one to play.',
    'taste.meTitle': 'Your taste',
    'taste.meStats': '{fav} favorites · {n} songs in your taste',
    'taste.filterAll': 'All',
    'taste.filterFriends': 'Friends',
    'taste.filterOthers': 'Others',
    'taste.filterEmpty': 'Nobody in this filter',
    'taste.playShared': 'Play shared',
    'taste.requestSent': 'Request sent',
    'taste.mapHint': 'You are in the center; closer means more alike (circles — 75/50/25% match). Green ring — friends. Tap a person to open the profile.',
    'taste.artistsHint': 'People and their favorite artists. Gold ring — your artists, green — friends; artist size — how many people love them.',
