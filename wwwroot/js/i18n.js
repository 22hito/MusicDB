...
const I18N = {
  uk: {
    ...
    'taste.heading.pre': 'Схожий',
    'taste.heading.accent': 'смак',
    ...
    'taste.loading': 'Шукаємо людей зі схожим смаком…',
    ...
    'taste.graphPeopleSub': 'Ви в центрі — ближче ті, чий смак схожіший',
    'taste.graphArtistsSub': 'Хто кого слухає і де ваші смаки перетинаються',
    ...
    'taste.fans': 'шанувальників: {n}',
    'taste.mapHint': 'У центрі — ви; ближче — схожіший смак (кола — 75/50/25% збігу), поруч — ті, хто любить того самого виконавця. Зелений обідок — друзі. Клік — профіль.',
    ...
    'taste.graphTitlePeople': 'Карта смаку',
    'taste.graphTitleArtists': 'Люди та їхні улюблені виконавці',
    'taste.you': 'ви',
    ...
    'taste.scoreHint': 'Збіг смаків: виконавці, жанри й спільні улюблені',
    ...
    'friends.loginHint': 'Увійдіть, щоб додавати друзів',
    ...
    'graph.allSongs': '← Усі пісні',
    'graph.egoTitle': 'Схожі на «{song}»',
    'graph.egoPlay': 'клік — відтворити',
    'graph.egoHint': 'У центрі — обрана пісня; ближче — схожіші (жанри, виконавець, альбом), поруч — того самого виконавця. Клік по пісні — граф навколо неї, по центральній — відтворити.',
    ...
    'admin.audioAddHint': 'Файлу ще немає — оберіть його, щоб додати',
  ...
  en: {
    ...
    'taste.heading.pre': 'Similar',
    'taste.heading.accent': 'taste',
    'taste.sub': 'People whose favorite songs and artists are close to yours. Based on favorites (♥) and listened songs.',
    'taste.loginHint': 'Log in to find people with similar taste',
    'taste.loading': 'Looking for people with similar taste…',
    ...
    'taste.graphPeopleSub': 'You are in the center — the closer, the more alike',
    'taste.graphArtistsSub': 'Who listens to whom and where your tastes meet',
    ...
    'taste.fans': 'fans: {n}',
    'taste.mapHint': 'You are in the center; closer means more alike (circles — 75/50/25% match), neighbours love the same artist. Green ring — friends. Click to open the profile.',
    ...
    'taste.graphTitlePeople': 'Taste map',
    'taste.graphTitleArtists': 'People and their favorite artists',
    'taste.you': 'you',
    ...
    'taste.scoreHint': 'Taste match: artists, genres and shared favorites',
    'nav.artists': 'Artists',
    'nav.friends': 'Friends',
    ...
    'friends.loginHint': 'Sign in to add friends',
    ...
    'graph.allSongs': '← All songs',
    'graph.egoTitle': 'Similar to “{song}”',
    'graph.egoPlay': 'click to play',
    'graph.egoHint': 'The chosen song is in the center, the most similar ones around it (genres, artist, album). Click a song to re-center, the center one to play.',
    ...
    'admin.audioAddHint': 'No file yet — pick one to add it',
