...
app/
  ...
  (tabs)/
    ...
    explore/              Огляд і рекомендації; wheel, battle, artists, artist/[id]
...
components/ UI-кіт, SongRow, SongListBlock, MarqueeText, SelectField, модалки (оцінки, текст, баг-репорт…)
...
- **Запити:** `ApiBridge` виконує `fetch` усередині прихованого WebView з тим самим origin і cookie-сесією, що й
  сайт, і там же слухає SignalR. Завантаження файлів (multipart) іде нативним `fetch` зі спільними куками.
